...
@Slf4j
@Service
public class PythonCodeEvaluator extends BaseCodeEvaluator {
    ...
    protected CodeExecutionResponse.TestCaseResult executeTestCase(Path codeFile, CodeExecutionRequest.TestCase testCase) throws Exception {
        ...
        try {
            ...
            ProcessBuilder runPb = createProcessBuilder(codeFile.getParent(), "python", codeFile.getFileName().toString());
